...
class Graphatrix {
  ...
  applyTransforms() {
    ...
    MatrixOperations.applyVerticesTransformations(this.vertices, this.matrixesController.transformationMatrix);
    MatrixOperations.applyPivotTransformations(this.pivotVertex, this.matrixesController.transformationMatrix);
  ...
  start() {
    ...
    // First calculations before drawing to set everything in place
    MatrixOperations.applyVerticesTransformations(this.vertices, this.matrixesController.transformationMatrix);
    MatrixOperations.applyPivotTransformations(this.pivotVertex, this.matrixesController.transformationMatrix);
