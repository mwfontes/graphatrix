...
class RotateMatrix extends BasicMatrix {
    ...
    updateMatrix() {
        ...
        this.matrixStructure[0][0] = Math.cos(Utils.degToRad(val) * 2);
        this.matrixStructure[0][1] = Math.sin(Utils.degToRad(val) * 2);
        this.matrixStructure[1][0] = Math.sin(Utils.degToRad(val) * 2);
        this.matrixStructure[1][1] = -Math.cos(Utils.degToRad(val) * 2);
