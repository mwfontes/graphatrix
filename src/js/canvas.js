class Canvas {
  ...
  drawPivot() {
    ...
    // draws modified pivot
    drawingCenter = [
      this.center[0] + Math.round(this.parent.pivotVertex.modifiedX * this.scale),
      this.center[1] - Math.round(this.parent.pivotVertex.modifiedY * this.scale)
    ];
